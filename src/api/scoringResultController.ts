...
export async function listScoringResultByPageUsingPost(
  ...
  return request<API.BaseResponsePageScoringResult_>('/scoringResult/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listScoringResultVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageScoringResultVO_>('/scoringResult/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyScoringResultVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageScoringResultVO_>('/scoringResult/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
