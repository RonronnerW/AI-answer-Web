...
/** like GET /app/like */
export async function likeUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.likeUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/app/like', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** appLikes GET /app/likes/${param0} */
export async function appLikesUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.appLikesUsingGETParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<API.BaseResponseListUserVO_>(`/app/likes/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
